...
def main():
    trigger = 0        # a place to start? this gets reset to start the roll
    end = 100         # number of lines to write
    outer_break = 0   # number of rolls to process
    ...
    while trigger < end:
        ...
        if trigger < offset_len:
            width = off_sets[trigger] + a_length + 12
